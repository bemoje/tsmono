[@bemoje/table](https://github.com/bemoje/tsmono/blob/main/docs/md/table/index.md) / Table
...
▸ **set**(`column`, `row`, `value`): [`Table`](https://github.com/bemoje/tsmono/blob/main/docs/md/table/classes/Table.md)<`T`\>
