...
Number related tools/util.

![npm (scoped)](https://img.shields.io/npm/v/%40bemoje/trie-map)
![npm bundle size (scoped)](https://img.shields.io/bundlephobia/minzip/%40bemoje/number)
![npm](https://img.shields.io/npm/dt/%40bemoje/number)
![NPM](https://img.shields.io/npm/l/%40bemoje%2Fnumber)
...
## Documentation
[Documentation Website](https://bemoje.github.io/tsmono/modules/number.html)
