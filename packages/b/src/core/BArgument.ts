...
export class BArgument<T extends ValidInputPrimitiveTypes = string> extends Argument {
  ...
  // protected parser?: (value: string, previous: T) => T
   ...
   *
   */
  // getParser(): (value: string, previous: T) => T {
  //   if (this.parser) return this.parser
  //   else return Reflect.get(this, 'parseArg')
  // }
  // setParser(value: (value: string, previous: T) => T):this {
  //   this.parser = value
  //   Object.defineProperty(this, 'parseArg', {value})
  //   super.argParser(value)
  //   return this
  // }
  // override argParser<P>(fn: (value: string, previous: P) => P): this {
  //   return this.setParser(fn as any)
  // }
  // get parseArg(): (value: string, previous: T) => T {
  ...
  // declare createPromptObject (cmd: BCommand) => AbstractPromptObject<T>
}
