...
Set related tools/util.

![npm (scoped)](https://img.shields.io/npm/v/%40bemoje/trie-map)
![npm bundle size (scoped)](https://img.shields.io/bundlephobia/minzip/%40bemoje/set)
![npm](https://img.shields.io/npm/dt/%40bemoje/set)
![NPM](https://img.shields.io/npm/l/%40bemoje%2Fset)
...
## Documentation
[Documentation Website](https://bemoje.github.io/tsmono/modules/set.html)
